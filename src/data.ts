class Post {
    ...
    constructor(public id: number, public title: string, public imageUrl: string, public body: string, public link: string) {
...
const postCard = ({ id, title, imageUrl, body , link}: {id: number, title: string, imageUrl: string, body: string, link: string}) => `
...
const postCardDetail = ({ id, title, imageUrl, body , link}: {id: number, title: string, imageUrl: string, body: string, link: string}) => `
